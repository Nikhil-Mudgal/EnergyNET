...
def data_analyse():
	...
	if choice == "Units":
		...
		with row2:
			img = Image.open("Units_seasonal.png")
			st.image(img)
		with row1:
			st.write("""
		...
		with row1:
			img1 = Image.open("Units_hourly.png")
			st.image(img1)
		with row2:
			st.write("""
		...
		with row1:
			...
			""")
		with row2:
			img2 = Image.open("Units_weekly.png")
			st.image(img2)
		
	if choice == "App1":
		img5 = Image.open("App-1_seasonal.png")
		st.image(img5)
		st.write("This is a short Description of above image")
		img3 = Image.open("App-1_hourly.png")
		st.image(img3)
		st.write("This is a short Description of above image")
		img4 = Image.open("App_weekly.png")
		st.image(img4)
		st.write("This is a short Description of above image")			
	if choice == "App2":
		img8 = Image.open("App-2_seasonal.png")
		st.image(img8)
		st.write("This is a short Description of above image")
		img6 = Image.open("App-2_hourly.png")
		st.image(img6)
		st.write("This is a short Description of above image")
		img7 = Image.open("App_weekly.png")
		st.image(img7)
		st.write("This is a short Description of above image")	
	if choice == "App3":
		img11 = Image.open("App-3_seasonal.png")
		st.image(img11)
		st.write("This is a short Description of above image")
		img9 = Image.open("App-3_hourly.png")
		st.image(img9)
		st.write("This is a short Description of above image") 
		img10 = Image.open("App_weekly.png")
		st.image(img10)
		st.write("This is a short Description of above image")
		#start from image 12