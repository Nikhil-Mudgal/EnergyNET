...
"""____________Test/Train Dataset split ___________"""
...
"""____________Look back Function for Single Output_______"""
...
"""____________Look back Function for Multiple Output_______"""
def create_dataset(X, y, time_steps=1):
    Xs, ys = [], []
    for i in range(len(X) - time_steps):
        v = X.iloc[i:(i + time_steps)].values
...
"""____________LSTM Framework_____________"""
...
"""___________Model Analysis___________"""
#Compiling the RNN
model = model_lstm
optimizer = 'adam'
loss = 'mse'
